...
<a href="/"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>NTP 设置</strong>
<hr>
<form action="" method="get">
<table border="0"  cellspacing="0" cellpadding="3" >
<tr><td align="right">
NTP 服务器:</td><td><input type="text" id="ntpserver" name="ntpserver" maxlength="172" value=""></td></tr>
<tr><td align="right">更新间隔:</td><td><input type="text" id="update" name="update" size="3"maxlength="6" value=""> 分钟 (0=不更新)</td></tr>
<tr><td>时区</td><td>
...
<tr><td align="right">启用夏令时:</td><td><input type="checkbox" id="dst" name="dst"></td></tr>
