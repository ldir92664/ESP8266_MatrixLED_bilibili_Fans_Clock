...
<a href="/"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>网络设置</strong>
<hr>
配置与路由器:<br>
<form action="" method="get">
<table border="0"  cellspacing="0" cellpadding="3" style="width:310px" >
<tr><td align="right">SSID:</td><td><input type="text" id="ssid" name="ssid" value=""></td></tr>
<tr><td align="right">密码:</td><td><input type="text" id="password" name="password" value=""></td></tr>
...
<tr><td align="right">子网掩码:</td><td><input type="text" id="nm_0" name="nm_0" size="3">.<input type="text" id="nm_1" name="nm_1" size="3">.<input type="text" id="nm_2" name="nm_2" size="3">.<input type="text" id="nm_3" name="nm_3" size="3"></td></tr>
<tr><td align="right">网关:</td><td><input type="text" id="gw_0" name="gw_0" size="3">.<input type="text" id="gw_1" name="gw_1" size="3">.<input type="text" id="gw_2" name="gw_2" size="3">.<input type="text" id="gw_3" name="gw_3" size="3"></td></tr>
...
<hr>
<strong>连接状态:</strong><div id="connectionstate">没有数据</div>
<hr>
<strong>网络:</strong><br>
<table border="0"  cellspacing="3" style="width:310px" >
<tr><td><div id="networks">扫描...</div></td></tr>
<tr><td align="center"><a href="javascript:GetState()" style="width:150px" class="btn btn--m btn--blue">
更新</a></td></tr>
</table>
...
void send_connection_state_values_html()
{
	...
	String state = "没有数据";
	String Networks = "";
	if (WiFi.status() == 0) state = "闲置";
	else if (WiFi.status() == 1) state = "没有可用的网络";
	else if (WiFi.status() == 2) state = "扫描完成";
	else if (WiFi.status() == 3) state = "连接已建立";
	else if (WiFi.status() == 4) state = "连接错误";
	else if (WiFi.status() == 5) state = "断开连接";
	else if (WiFi.status() == 6) state = "没有连接";
	 ...
	 if (n == 0)
	 {
		 Networks = "<font color='#FF0000'>找不到网络!</font>";
	 }
	else
    {
	 
		
		Networks = "可用网络: " +String(n) + "<br>";
		Networks += "<table border='0' cellspacing='0' cellpadding='3'>";
		Networks += "<tr bgcolor='#DDDDDD' ><td><strong>名称</strong></td><td><strong>质量</strong></td><td><strong>保护</strong></td><tr>";
		for (int i = 0; i < n; ++i)
		{
			int quality=0;
			if(WiFi.RSSI(i) <= -100)
